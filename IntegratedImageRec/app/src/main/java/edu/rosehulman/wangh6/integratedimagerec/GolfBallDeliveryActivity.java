...
public class GolfBallDeliveryActivity extends RobotActivity {
     ...
     */
    private Button mTeamChangeButton, mGoOrMissionCompleteButton, mJumbo_go_or_mission_complete_button;
...
//        setContentView(R.layout.main_screen);
        ...
        mJumbo_go_or_mission_complete_button = (Button) findViewById(R.id.Jumbo_go_or_mission_complete_button);
        mJumboLinearLayout = findViewById(R.id.jumbo_linear_layout);
...
//        Log.d(TAG, "This is loop within our subclass of Robot Activity");
    ...
    public void handleGoOrMissionComplete(View view) {
        if (mState == State.READY_FOR_MISSION) {
            ...
            mJumbo_go_or_mission_complete_button.setBackgroundResource(R.drawable.red_button);
            mJumbo_go_or_mission_complete_button.setText("STOP!");
